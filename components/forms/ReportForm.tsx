    ...
    <>
      ...
      >
        <div className="space-y-4">
          <div>
            <label className="block text-sm font-semibold mb-2 text-gray-900">Tipo de Defecto</label>
            <select
              value={newDefect.type || ''}
              onChange={(e) => setNewDefect({ ...newDefect, type: e.target.value as DefectType })}
          ...
          <div>
            <label className="block text-sm font-semibold mb-2 text-gray-900">Zona del Defecto</label>
            <select
              value={newDefect.zone || ''}
              onChange={(e) => setNewDefect({ ...newDefect, zone: e.target.value as Zone })}
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
              <option value="">Selecciona...</option>
              {zones.map(zone => (
