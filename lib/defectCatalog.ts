...
export const damageTypes: DamageOption[] = [
  { code: '01', label: 'Doblado, Torcido, Impactado' },
  { code: '02', label: 'Roto / Quebrado (Excepto vidrio)' },
  { code: '03', label: 'Cortado'},
  { code: '04', label: 'Abollado'},
  { code: '05', label: 'Despostillado (Excepto en vidrio y filos)'},
  { code: '06', label: 'Agrietado (Excepto Vidrio)' },
  { code: '07', label: 'Rayon Profundo' },
  { code: '08', label: 'Faltante (Perdido excepto molduras/emblemas)' },
  { code: '09', label: 'Raspado (Tallon)' },
  { code: '10', label: 'Interior Sucio, manchado' },
  { code: '11', label: 'Perforado (Ponchado)' },
  { code: '12', label: 'Rayon (Rayado)' },
  { code: '13', label: 'Rasgado' },
  { code: '14', label: 'Abollado (Sin daños a pintura o cromo)' },
  ...
  { code: '18', label: 'Molduras, emblemas, botaguas Dañados' },
  { code: '19', label: 'Molduras, emblemas, botaguas faltantes o sueltos' },
  ...
  { code: '22', label: 'Vidrio despostillado | Fragmento removido por impacto' },
  { code: '23', label: 'Vidrio rayado | Raya lineal en el cristal' },
  { code: '24', label: 'Cuarto o direccional Dañada' },
  { code: '25', label: 'Calcomania Dañada' },
  { code: '29', label: 'Contaminación, Exterior | Polvo industrial, óxido, pintura, lluvia ácida' },
  { code: '30', label: 'Manchas o Fluidos en exterior' },
  { code: '31', label: 'Robo y vandalismo | Remoción no autorizada o destrucción deliberada' },
  { code: '34', label: 'Despostillado en Filo' },
  { code: '36', label: 'Parte incorrecta o accesorio no como facturado | No es daño de transportación' },
  { code: '37', label: 'Elementos fijados al exterior del vehículo dañados' },
  { code: '38', label: 'Elementos fijados al exterior del vehículo faltantes o sueltos' },
];
